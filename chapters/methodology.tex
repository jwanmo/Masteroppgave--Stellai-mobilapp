...
\subsection{Prosjektgjennomføring og fremdrift}
 
Masterprosjektet ble gjennomført som et iterativt løp der utvikling, brukerevaluering og skriving grep inn i hverandre. Den første utviklingsfasen etablerte selve applikasjonen, fra teknologivalg og oppsett av React Native og Firebase til implementering av registreringsflyt, Azure-integrasjon og håndtering av bilder og metadata. Deretter fulgte de to rundene med brukerevaluering, der funnene fra den første undersøkelsen dannet grunnlaget for de målrettede designendringene som ble vurdert på nytt i den andre runden. Selve skrivearbeidet med resultat- og diskusjonskapitlet ble lagt til den avsluttende fasen, slik at de empiriske funnene kunne tolkes opp mot det teoretiske rammeverket. Figur~\ref{fig:gantt} viser fremdriften i denne avsluttende fasen, der de siste utviklingsoppgavene overlapper med brukerevalueringen og skrivearbeidet. En fullstendig oversikt over hele prosjektløpet er gjengitt i appendiks (figur~\ref{fig:gantt-full}).
 
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/Gantt_sluttfase.png}
    \caption{Fremdrift i prosjektets avsluttende fase (januar–juni), der de siste utviklingsoppgavene overlapper med brukerevalueringen og skrive- og innleveringsarbeidet.}
    \label{fig:gantt}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/undersokelse_rapport_for_endringer.png}
    \caption{Resultater fra spørreundersøkelsen før designendringer (n=31). Figuren viser prosentvis gjennomsnittsskår per spørsmål, beregnet som gjennomsnittsskår delt på maksimal skår på 7.}
    \label{fig:survey-before}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/undersokelse_rapport_etter_endringer.png}
    \caption{Resultater fra spørreundersøkelsen etter designendringer (n=21). Figuren viser prosentvis gjennomsnittsskår per spørsmål, beregnet som gjennomsnittsskår delt på maksimal skår på 7.}
    \label{fig:survey-after}
\end{figure}
